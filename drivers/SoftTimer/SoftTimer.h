...
extern UINT32 softtimer_create_timer(HTIMER *phTm, UINT32 ulLength, UINT8 ucMode, SOFTTIMER_FUNC TimeOutRoutine, UINT32 ulParam, char *ulFileID, UINT32 ulLineNo);
