...
struct msm_vfe_callback {
	void	(*vfe_resp)(struct msm_vfe_resp *, enum msm_queue, void *syncdata);
...
struct msm_camvfe_fn {
	...
	int	(*vfe_disable)(struct camera_enable_cmd *, struct platform_device *dev);
...
struct msm_v4l2_driver {
	...
	unsigned int		(*drv_poll) (struct msm_sync *, struct file *, struct poll_table_struct *);
};
