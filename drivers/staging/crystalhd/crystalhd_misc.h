...
typedef void (*hw_comp_callback)(struct crystalhd_dio_req *, wait_queue_head_t *event, enum BC_STATUS sts);
...
extern enum BC_STATUS crystalhd_map_dio(struct crystalhd_adp *, void *, uint32_t, uint32_t, bool, bool, struct crystalhd_dio_req **);
